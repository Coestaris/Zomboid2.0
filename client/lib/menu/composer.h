...
menu_container_child_t* composer_messageBox_1btn(gameObject_t* parent, char* string, char* s1, int btnTex,
                                               void* font, color_t fontColor, int tex, void (*func)(void));

menu_container_child_t* composer_messageBox_2btn(gameObject_t* parent, char* text, char* s1, char* s2, int btnTex,
                                               void* font, color_t fontColor, int tex, void (*func1)(void), void (*func2)(void));

menu_container_child_t* composer_input_double(gameObject_t* parent, char* sl1, char* sl2, char* s1, char* s2,
